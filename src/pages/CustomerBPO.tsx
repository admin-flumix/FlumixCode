        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8" id="customer-bpo-bento">
          {customerBpoDetailed.map((service, idx) => (
            <motion.div
              ...
              className={`flex flex-col scroll-mt-24 h-full rounded-2xl border border-slate-200 bg-white p-6 sm:p-8 shadow-sm transition-all duration-300 ${service.borderColor} hover:shadow-md relative overflow-hidden`}
            >
