        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-5 space-y-4" id="quick-contact-left">
              ...
              <h2 className="font-display text-3xl font-bold text-slate-900">Let's Talk About Your Data.</h2>
              <p className="text-sm text-slate-600 leading-relaxed">
                Get in touch with our London-based team for a free, no-obligation consultation. We'll take the time to understand your goals, discuss your challenges, and explore the best way to move your project forward.
              </p>
              <div className="space-y-2 pt-2 text-xs text-slate-500">
                <div className="flex items-center gap-2">
                  <span className="h-1.5 w-1.5 rounded-full bg-gray-500" />
                  <span>Your ideas and business information are kept confidential.We're happy to sign a mutual NDA before discussing your project.</span>
                </div>
                <div className="flex items-center gap-2">
                  <span className="h-1.5 w-1.5 rounded-full bg-gray-500" />
                  <span>Flexible deployment options are available to meet your security, compliance, and data residency requirements.</span>
                </div>
              </div>
            </div>
