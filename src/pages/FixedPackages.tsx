...
export default function CustomerBPO({ setCurrentPage, onOpenConsultation }: CustomerBPOProps) {
  ...
  const fixedPackagesForAP = [
    ...
    {
        "id": "executive-dashboard-package",
  ...
  const fixedPackagesForDE = [
    ...
    },
    {
        ...
        "description":"A collaborative workshop to identify high-value AI and Generative AI opportunities across your business.",
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10 space-y-12">
        ...
        <div className="space-y-6">
            ...
            {fixedPackagesForDDSP.map((fpackage, idx) => (
                ...
                className={`flex flex-col scroll-mt-24 h-full rounded-2xl border border-slate-200 bg-white p-6 sm:p-8 shadow-sm transition-all duration-300 ${fpackage.borderColor} hover:shadow-md relative overflow-hidden`}
                >
