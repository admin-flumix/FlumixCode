      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10 space-y-16">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <p className="text-base text-slate-600 leading-relaxed">
            Whether you're modernising your data platform, improving analytics, or exploring AI, our consultants will help you define the right strategy and create a practical roadmap for success.
          </p>
        </div>
          ...
          <div className="lg:col-span-5 space-y-8" id="contact-left-details">
            ...
            <div className="space-y-4 text-xs text-slate-800" id="contact-coordinates">
              <div className="flex items-start gap-3 p-4 rounded-2xl border border-slate-200 bg-white transition-all hover:border-blue-500/10 hover:bg-slate-50/50 shadow-sm">
                ...
                <div>
                  ...
                  <p className="text-slate-600 mt-1 leading-relaxed">
                    Head Office: <strong>Kemp House, 160 City Road,  London, EC1V 2NX</strong>
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-4 rounded-2xl border border-slate-200 bg-white transition-all hover:border-blue-500/10 hover:bg-slate-50/50 shadow-sm">
                ...
                <div>
                  <span className="block font-bold text-slate-900">Email us on</span>
                  <p className="text-slate-600 mt-1 leading-relaxed">
                    Inquiry at: <a href="mailto:inquiries@flumix.co.uk" className="text-slate-900 font-bold">inquiries@flumix.co.uk</a><br />
                    Support at: <a href="mailto:support@flumix.co.uk" className="text-slate-900 font-bold">support@flumix.co.uk</a><br />
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 p-4 rounded-2xl border border-slate-200 bg-white transition-all hover:border-blue-500/10 hover:bg-slate-50/50 shadow-sm">
                ...
                <div>
                  <span className="block font-bold text-slate-900">Call us on</span>
                  <p className="text-slate-600 mt-1 leading-relaxed">
                    Tel: <a href="tel:+44 77 3435 4500" className="text-slate-900 font-bold">+44 77 3435 4500</a><br />
            ...
            <div className="rounded-2xl border border-indigo-100 bg-indigo-50/50 p-5 space-y-3" id="nda-commitment-box">
              ...
              <p className="text-2xs text-slate-600 leading-relaxed">
                Your ideas and business information matter to us. If you'd like to share confidential details, we're happy to sign a mutual Non-Disclosure Agreement (NDA) before we discuss your project.
              </p>
            </div>
          </div>
                ...
                {!isSubmitSuccess ? (
                  ...
                  >
                    <div className="space-y-1.5 border-b border-slate-200 pb-3">
                      <h3 className="font-display text-xl font-bold text-slate-900">Let’s Talk!</h3>
