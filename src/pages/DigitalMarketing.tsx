        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8" id="marketing-services-bento">
          {digitalMarketingDetailed.map((service, idx) => (
            <motion.div
              ...
              className={`flex flex-col h-full scroll-mt-24 rounded-2xl border border-slate-200 bg-white p-6 sm:p-8 shadow-sm transition-all duration-300 ${service.borderColor} hover:shadow-md relative overflow-hidden`}
            >
