          ...
          <AnimatePresence mode="popLayout">
            {filteredServices.map((service) => (
              <motion.div
                ...
                className="rounded-2xl scroll-mt-24 border border-slate-200 bg-white p-6 md:p-10 shadow-sm space-y-8 hover:border-blue-500/20 hover:shadow-md transition-all duration-300"
