...
export const TESTIMONIALS = [
  {
    quote:
      "Working with the team has been a great experience. Their professionalism, responsiveness, and clear communication throughout the project made the entire process seamless. They consistently delivered quality work on time and were proactive in addressing our requirements. I highly recommend them to any business looking for a reliable development partner.",
    author: "Matt Lonergan",
    role: "CEO",
    company: "PMPRO"
  },
  {
    quote:
      "From the initial consultation to the final delivery, the team demonstrated exceptional technical expertise and a genuine commitment to our success. They took the time to understand our business objectives and delivered a solution that exceeded our expectations. Their attention to detail and dedication to quality made them a trusted partner throughout the project.",
  ...
  {
    quote:
      "The collaboration was smooth, transparent, and highly productive. Every milestone was delivered on schedule, and the team was always available to answer questions and implement feedback. Their ability to transform our ideas into a polished, scalable solution was truly impressive.",
    author: "Jenny Junkeer",
    role: "Founder & CEO",
    company: "INTENT"
  },
  // {
  //   quote:
  //     "We were looking for a development partner who could combine technical excellence with outstanding communication, and that's exactly what we found. The team's proactive approach, problem-solving mindset, and commitment to delivering high-quality results made the entire experience stress-free. We look forward to working together again.",
  //   author: "[Client Name]",
  ...
  // {
  //   quote:
  //     "Their professionalism and technical expertise were evident from day one. The team quickly understood our requirements, provided valuable recommendations, and consistently delivered beyond expectations. The final product has had a positive impact on our business, and I wouldn't hesitate to recommend their services.",
  //   author: "[Client Name]",
  ...
  // {
  //   quote:
  //     "What stood out most was their responsiveness and attention to detail. They kept us informed throughout every phase of the project, welcomed our feedback, and ensured the final solution aligned perfectly with our goals. It was a pleasure working with such a knowledgeable and reliable team.",
  //   author: "[Client Name]",
  //   role: "Co-Founder",
  //   company: "[Company]"
  // },
  // {
  //   quote:
  //     "This project exceeded our expectations in every way. The team's expertise, dedication, and collaborative approach made a significant difference to the outcome. They delivered a high-quality solution that not only met our current needs but also provides a solid foundation for future growth.",
  //   author: "[Client Name]",
  //   role: "Director",
  //   company: "[Company]"
  // }
